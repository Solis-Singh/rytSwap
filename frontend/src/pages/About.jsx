...
const teamMembers = [
  ...
  },
  {
    ...
    bio: 'Designs delightful user experiences and beautiful interfaces for RYT.'
  },
  {
    name: 'Alpna',
    role: 'Manager',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-pink-50 to-blue-100 py-12 px-4 sm:px-6 lg:px-8 mt-12">
        ...
        <div className="mt-16">
          <div className="text-center mb-12 ">
              <h1 className="text-4xl font-bungee">Our Mission</h1>
                <p className="text-gray-700 max-w-2xl mx-auto font-lilgrotesk">
                  At RYT (Rent Your Things), our mission is to create a sustainable sharing economy by connecting people who need things with those who have them. We believe in reducing waste, promoting resource efficiency, and helping people save money.
                </p>
                <p className='text-gray-700 max-w-2xl mx-auto font-lilgrotesk'>
      ...
      {/* How It Works Section */}
        ...
        {/* Benefits Section */}
        <div className="mt-16">
          <h2 className="text-3xl font-bungee text-center">Why Choose RYT?</h2>
        ...
        <div className="text-center mt-12">
          ...
          <p className="text-gray-700 max-w-xl mx-auto font-lilgrotesk">
            Whether you want to rent, lend, or simply connect, RYT is here to help you make the most of what you have—and find what you need. Thank you for being part of our journey!
          </p>
        </div>
      </div>
    </div>
